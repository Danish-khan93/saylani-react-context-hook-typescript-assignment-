  ...
  return (
   ...
   < AuthContext.Provider value={{login}}>
      ...
      <Routes>
        ...
        <Route path="admin" element={<AdminProtected userauth = {userauth} Component={DashBoard} />} >
        ...
        <Route path="/user" element={<UserProtected userauth = {userauth} Component={UserHome} />} />
